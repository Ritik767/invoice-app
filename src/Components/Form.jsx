...
const Form = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div
      className={`w-1/2 h-screen bg-[#1E2139] px-10 pt-10 fixed top-0 overflow-y-auto left-20 z-10${
        isOpen ? "w-1/2" : "w-0"
      }`}
    >
      <h1 className="text-[#F8F8FB] text-[30px] font-bold font-[Spartan]">
        New Invoice
      </h1>
      <div className="mt-12">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-3 gap-6 py-6">
          ...
          <div className="productInput col-span-3">
            ...
            <input
              ...
              id="clientEmail"
            />
            <p className="text-sm text-red-500">{error?.clientEmail}</p>
          </div>
          <div className="productInput col-span-3">
            <label htmlFor="streetAddress">Street Address</label>
            <input
        ...
        <div className="flex items-center justify-between pb-4">
          <button
            ...
            type="reset"
            className="bg-[#F8F8FB] px-6 py-3 rounded-full text-[#7E88C3] font-semibold"
          >
            Discard
          </button>
          <div className="flex justify-between items-center gap-4">
            <button
              type="submit"
              className="px-6 py-3 rounded-full bg-[#888EB0] text-[#F8F8FB] font-semibold"
            >
              Save as Draft
            </button>
            <button
              type="submit"
              className="px-6 py-3 rounded-full bg-[#7C5DFA] text-[#F8F8FB] font-semibold"
            >
              Save & Send
            </button>
          </div>
